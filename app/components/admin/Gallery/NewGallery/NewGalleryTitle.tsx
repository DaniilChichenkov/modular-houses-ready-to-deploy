...
const NewGalleryTitle = () => {
  ...
  //Store
  const title = useNewGalleryStore((state) => state.title.content);
  const titleLang = useNewGalleryStore((state) => state.title.selectedLang);
  const setTitle = useNewGalleryStore((state) => state.setTitle);
  const setTitleLang = useNewGalleryStore((state) => state.selectTitleLanguage);
...
export default NewGalleryTitle;
