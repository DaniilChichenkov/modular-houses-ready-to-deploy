...
const ChangeGalleryContentItem = ({
  uuid,
  previewUrl,
}: {
  uuid: string;
  ...
  const changeImage = useChangeGalleryStore((state) => state.changeImage);
  const deleteImage = useChangeGalleryStore((state) => state.deleteImage);
...
const ChangeGalleryContent = () => {
  const addImages = useChangeGalleryStore((state) => state.addImages);
  const images = useChangeGalleryStore((state) => state.images);
...
export default ChangeGalleryContent;
