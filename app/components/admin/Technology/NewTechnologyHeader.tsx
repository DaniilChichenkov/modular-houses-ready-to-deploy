...
const NewTechnologyHeader = () => {
  //Store
  const title = useNewTechnologyItemStore((state) => state.title.content);
  const titleLang = useNewTechnologyItemStore(
    (state) => state.title.selectedLang
  );
  const setTitle = useNewTechnologyItemStore((state) => state.setTitle);
  const setTitleLang = useNewTechnologyItemStore((state) => state.setTitleLang);
