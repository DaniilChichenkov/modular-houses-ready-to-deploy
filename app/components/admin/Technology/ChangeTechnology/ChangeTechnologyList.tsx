...
const ChangeTechnologyListItem = ({
  type,
  parentUUid,
  lang,
  content,
  ...
  const deleteListItem = useChangeTechnologyItemStore(
    (state) => state.deleteListItem
  );
  const setListItemContent = useChangeTechnologyItemStore(
    (state) => state.setListItemContent
  );
  const setListItemLinkRoute = useChangeTechnologyItemStore(
...
const ChangeTechnologyList = ({
  ...
  const setListLanguage = useChangeTechnologyItemStore(
  ...
  const setListTitleContent = useChangeTechnologyItemStore(
    (state) => state.setListTitleContent
  );

  //Add new item
  const addListItem = useChangeTechnologyItemStore(
    (state) => state.addListItem
  );
...
export default ChangeTechnologyList;
