...
const NewTechnologyLink = ({
  ...
  const setLinkRoute = useNewTechnologyItemStore((state) => state.setLinkRoute);
  ...
  const setLinkAnnotationContent = useNewTechnologyItemStore(
    (state) => state.setLinkAnnotationContent
  );
  const setLinkInnerContent = useNewTechnologyItemStore(
...
export default NewTechnologyLink;
