...
const ChangeProjectFullDescriptionForm = () => {
  //Languages
  ...
  const fullDesc = useChangeProjectStore((state) => state.fullDesc);
  const setFullDescription = useChangeProjectStore(
    (state) => state.setFullDescription
  );
  const selectFullDescriptionLanguage = useChangeProjectStore(
...
export default ChangeProjectFullDescriptionForm;
