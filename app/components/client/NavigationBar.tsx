  ...
  return (
    <>
      <header className="bg-[rgb(255,255,246)] relative z-20">
        ...
        >
          <button className="block text-teal-600 w-[3rem]">
            <img className="aspect-square" src={logo} alt="Logo" />
            ...
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                <button
                  ...
                  className="text-gray-500 transition hover:text-gray-500/75 lg:text-lg"
                >
      ...
      <NavigationMenuMobile
        ...
        marginTop={barHeight}
        handleNavigationItemClick={handleMobileMenuNavigationClick}
      />
    </>
  );
};
