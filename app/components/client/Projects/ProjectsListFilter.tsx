...
const ProjectsListFilter = () => {
  ...
  return (
    <div className="w-full mt-10 md:mt-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-5 items-start gap-4 sm:gap-6 mb-10 mt-5 md:mt-5 relative z-40">
        ...
        <details open={openedFilterDropdownId === 0} className="group relative">
          ...
          <div className="z-40 w-64 divide-y divide-gray-300 rounded border border-gray-300 bg-white shadow-sm group-open:absolute group-open:start-0 md:group-open:start-0 group-open:top-8">
            ...
            <form ref={roomsQtyFormRef} className="flex items-center gap-3 p-3">
        ...
        {/* Area */}
        <details open={openedFilterDropdownId === 3} className="group relative">
          <summary
        ...
        {/* Floors qty */}
        <details open={openedFilterDropdownId === 4} className="group relative">
          <summary
        ...
        <button
          ...
          className="cursor-pointer flex items-center gap-2 border-b border-indigo-300 pb-1 text-indigo-700 transition-colors hover:border-indigo-400 hover:text-indigo-900"
        >
          Apply filters
        </button>
        ...
        <button
          ...
          className="cursor-pointer flex items-center gap-2 border-b border-red-300 pb-1 text-red-700 transition-colors hover:border-red-400 hover:text-red-900 "
        >
          Drop filters
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-5 items-start gap-4 sm:gap-6 mb-10 mt-5 md:mt-5 relative z-30">
        {/* Order by price */}
        <details open={openedFilterDropdownId === 2} className="group relative">
          <summary
            ...
            className="cursor-pointer flex items-center gap-2 border-b border-gray-300 pb-1 text-gray-700 transition-colors hover:border-gray-400 hover:text-gray-900 [&::-webkit-details-marker]:hidden"
          >
            <span className="text-sm font-medium"> Упорядочить по цене: </span>
